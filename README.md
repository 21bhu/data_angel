...
5.  [Analysis Process](#analysis-process)
    ...
    *   [3\. Data Exploration and Summary Statistics](#3-data-exploration-and-summary-statistics)
        
    *   [4\. Data Merging](#4-data-merging)
        
    *   [5\. Data Visualization](#5-data-visualization)
        
        *   [a. Relationship Between Minutes Asleep and Time in Bed](#a-relationship-between-minutes-asleep-and-time-in-bed)
            
        *   [b. Relationship Between Total Steps and Calories Burned](#b-relationship-between-total-steps-and-calories-burned)
            
        *   [c. Average Total Intensities by Hour of the Day](#c-average-total-intensities-by-hour-of-the-day)
            
        *   [d. Steps vs. Sedentary Minutes](#d-steps-vs-sedentary-minutes)
...
2.  **Encourage Increased Activity Levels:**
...
3.  **Optimize Engagement During Peak Hours:**
